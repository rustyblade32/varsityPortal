        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    DepartmnetID = table.Column<int>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EnrollmentSectionId = table.Column<int>(nullable: true),
                    EnrollmentStudentId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        columns: x => new { x.EnrollmentSectionId, x.EnrollmentStudentId },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Marks_EnrollmentSectionId_EnrollmentStudentId",
                table: "Marks",
